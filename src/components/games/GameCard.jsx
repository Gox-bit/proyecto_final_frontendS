        ...
        <div className="group relative bg-[#151921] border border-gray-800 rounded-2xl overflow-hidden flex flex-col hover:shadow-2xl hover:shadow-purple-900/20 hover:-translate-y-1 transition-all duration-300 h-full">
            ...
            <div className="p-5 flex flex-col flex-grow">
                <div className="mb-2">
                    ...
                    <h3 className="text-lg font-bold text-white leading-tight group-hover:text-purple-400 transition-colors line-clamp-1" title={titulo}>
                        {titulo}
                    </h3>
                    
                    <p className="text-gray-400 text-xs mt-2 line-clamp-3 h-12 leading-relaxed">
